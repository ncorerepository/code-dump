						...
						%>
								<div class="boxs-tab">
									<div class="animated fadeIn active" data-box="1">
										<img style="height:270px !important; width:370px !important;" src="${pageContext.servletContext.contextPath}/resources/UploadImage/Artisan/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" data-at2x="${pageContext.servletContext.contextPath}/resources/UploadImage/Artisan/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" alt>
									</div>
								</div>	
						<%
							}else{
