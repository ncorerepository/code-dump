...
public class Trainer {
	...
	public Trainer(int id, String name, String name_b, String email,
			...
			String pinCode, String landMark, int experience_b,
			...
			String isArtisan, String createdOn, int createdBy,
			String updatedOn, int updatedBy, String status, int artisanId) {
		super();
		this.id = id;
		this.name = name;
		this.name_b = name_b;
	...
	public String getIsArtisan() {
		return isArtisan;
	}


	public void setIsArtisan(String isArtisan) {
		this.isArtisan = isArtisan;
	}
	...
	public int getExperience_b() {
		return experience_b;
	}

	public void setExperience_b(int experience_b) {
		this.experience_b = experience_b;
	}
