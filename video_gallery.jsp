<%@page import="com.karumoti.model.VideoGallery"%>
<!DOCTYPE HTML>
<html>
<head>
	<title>NCoRe</title>
...
<body>
			...
			<%
				List<VideoGallery> videoGalleryList = (List<VideoGallery>)request.getAttribute("videoGalleryList");
			%>
		...
		<main>
			<div class="isotope-container">
				...
				<div class="grid-col-row">
					...
					<%
							for(int i=0;i<videoGalleryList.size();i++)
							{
								VideoGallery videoGallery = videoGalleryList.get(i);
						%>
						<div class="item">
							<div class="video-player">
								<iframe src="<%=videoGallery.getUrl() %>"></iframe>
							</div>
							<center><h4><%=videoGallery.getVideoName() %></h4></center>
						</div>
