...
<body>
		...
		<%
				List<Trainer> artisanList = (List<Trainer>)request.getAttribute("artisanList");
				String msg = "";
				try
				{
	...
	%>
			<main>
				...
				<div class="grid-col-row clear-fix">
					...
					<!-- <div class="grid-col grid-col-4">
						<h4><p align="right">Search Trainer by Art-Form</p></h4>
					</div>
					<div class="grid-col grid-col-4">
				...
				<section>
					<div class="clear-fix">
						...
						{
							Trainer artisan = artisanList.get(i);
					%>
							...
							<div class="grid-col grid-col-4">
								...
								<div class="course-item">
									<%-- <div class="course-hover" style="width:370px;height:270px;">
										<img width="100%" height="100%" src="${pageContext.servletContext.contextPath}/resources/UploadImage/Trainer/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" data-at2x="${pageContext.servletContext.contextPath}/resources/UploadImage/Trainer/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" alt>
										<div class="hover-bg bg-color-1"></div>
										<a href="${pageContext.servletContext.contextPath}/trainer/<%=artisan.getId()%>">View Details</a>
									</div> --%>
									
									<div class="picture" >
									<div >
									<!-- <div class="link-cont"> -->
										 <a href="${pageContext.servletContext.contextPath}/trainer/<%=artisan.getId()%>" >
									 
								 	<img style="height:270px;" src="${pageContext.servletContext.contextPath}/resources/UploadImage/Trainer/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" data-at2x="${pageContext.servletContext.contextPath}/resources/UploadImage/Trainer/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" alt>
								</a>
								</div>
								 </div>
								 
									<div class="course-name clear-fix">
										<span class="price"><%=artisan.getAddressLine1() %> Trainer</span>
									<h3><a href="${pageContext.servletContext.contextPath}/trainer/<%=artisan.getId()%>"><b><font color="#00CC66"><%=artisan.getName()%></font></b></a></h3>
										</div>
