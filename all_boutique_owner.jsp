...
<body>
		...
		<%
				List<BoutiqueOwner> artisanList = (List<BoutiqueOwner>)request.getAttribute("artisanList");
	...
	<div class="page-content">
		<div class="container">
			...
			%>
				...
				<main>
				<h2 class="margin-none">Our Boutique Owner</h2>	
				...
				<section>
					<div class="clear-fix">
						...
						{
							BoutiqueOwner artisan = artisanList.get(i);
					%>
							...
							<div class="grid-col grid-col-4">
								...
								<div class="course-item">
									...
									<div >
									<!-- <div class="link-cont"> -->
										 <a href="${pageContext.servletContext.contextPath}/boutique_owner/<%=artisan.getId()%>" >
									 
								 	<img style="height:270px;" src="${pageContext.servletContext.contextPath}/resources/UploadImage/BoutiqueOwner/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" data-at2x="${pageContext.servletContext.contextPath}/resources/UploadImage/Artisan/<%=artisan.getId()%>/<%=artisan.getProfilePicture() %>" alt>
								</a>
								</div>
								 </div>
